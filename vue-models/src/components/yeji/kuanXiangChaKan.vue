<template>
  <div id="app">
	<ContractTop tle="查看" tleurl="/index" style="position:fixed;top:0px;"></ContractTop>
	<div style="margin-top:44px;" >
		<ul
			v-infinite-scroll="loadMore"
			infinite-scroll-disabled="loading"
			infinite-scroll-distance="10">
			<li v-for="item in list"><fenPeiListBlock  v-bind:readOrNo="true" v-bind:message="item"></fenPeiListBlock></li>
		</ul>
	</div>
