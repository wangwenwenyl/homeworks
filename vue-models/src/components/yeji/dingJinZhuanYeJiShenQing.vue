<template>
  <div id="app">
	<ContractTop tle="定金转业绩申请" tleurl="/index" style="position:fixed;top:0px;"></ContractTop>
    ...
    <mt-loadmore
      ...
      :class="cls"
    >
      <div v-for="item in list"><dingJinZhuanYeJiShenQingBlock  v-bind:message="item"></dingJinZhuanYeJiShenQingBlock></div>
    </mt-loadmore>
	</div>
</template>
<script>
...
import dingJinZhuanYeJiShenQingBlock from '@/components/yeji/dingJinZhuanYeJiShenQingBlock';
...
export default {
  ...
  components:{
    ...
    'dingJinZhuanYeJiShenQingBlock':dingJinZhuanYeJiShenQingBlock
  }
}
</script>
