<template>
  <div id="app">
    <ContractTop tle="退定金申请" tleurl="/index" style="position:fixed;top:0px;z-index: 999;"></ContractTop>
    ...
    >
      <div>
        <ul>
          <li v-for="item in items"><tuiDingJinZhiChuShenQingList  v-bind:message="item" :luRuName="luRuName"></tuiDingJinZhiChuShenQingList></li>
        </ul>
      </div>
...
<script>
  ...
  import huiKuanLuRuBlock from '@/components/yeji/huiKuanLuRuBlock';
  import huiKuanLuRuHistoryBlock from '@/components/yeji/huiKuanLuRuHistoryBlock';
  import axios from 'axios';
  import taiZhangHaoSearch from '@/components/yeji/taiZhangHaoSearch.vue';
  import noData from '@/components/noData';
  import tuiDingJinZhiChuShenQingList from '@/components/yeji/tuiDingJinZhiChuShenQingList.vue';
...
//        });
    ...
    components:{
      ...
      'huiKuanLuRuBlock':huiKuanLuRuBlock,
      'huiKuanLuRuHistoryBlock':huiKuanLuRuHistoryBlock,
      'tai-zhang-hao-search': taiZhangHaoSearch,
      'noData': noData,
      'tuiDingJinZhiChuShenQingList':tuiDingJinZhiChuShenQingList
    }
  }
</script>
