<template>
  <div id="app" style="overflow-Y:scroll;">
    <ContractTop tle="报备审批" tleurl="/index" style="position:fixed;top:0px;z-index:999;"></ContractTop>
    <baoBeiShenPiBlock style="margin-top:44px;"></baoBeiShenPiBlock>
  </div>
</template>
<script>
  import ContractTop from '@/components/ContractTop';
  import baoBeiShenPiBlock from '@/components/old/baoBeiShenPiBlock';
  ...
  export default {
    ...
    components:{
      ...
      'baoBeiShenPiBlock':baoBeiShenPiBlock
    }
  }
</script>
