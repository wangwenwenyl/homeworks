...
<template>
    <form id="fangbaobei" action="" style="overflow-Y:scroll;" >
        ...
        <div class="iterm" v-else>
            ...
            <!--<reportTime v-bind:title="'报备时间'" v-bind:time="fangbaobei.time" v-on:date="report"></reportTime>-->
        </div>
        <div class="iterm">
            <span class="star">*</span>
        ...
        <!--<div class="iterm">-->
            ...
            <!--<input v-if="step==0" type="text" v-bind:disabled="detailShow" name="zhuguan" class="word5" id="zhuguan" v-model="fangbaobei.zhuguan"/>-->
            <!--<input v-else type="text" disabled name="zhuguan" class="word5" id="zhuguan" value="***********"/>-->
        <!--</div>-->
        <div class="iterm">
            <span class="star">*</span>
        ...
        <div class="iterm" v-else>
            <label for="">做单时间：</label>
            <input v-bind:disabled="detailShow" type="date" name="zuodantime" class="word5" v-model="fangbaobei.zuodantime"/>
            <!--<singleTime v-bind:title="'做单时间'" v-bind:time="fangbaobei.zuodantime" v-on:date="single"></singleTime>-->
        </div>
        <div class="iterm">
            <span class="star">*</span>
        ...
        <div class="iterm">
            ...
            <input type="text" v-if="step==0" v-bind:disabled="detailShow" name="custphone" class="word5" v-model="fangbaobei.custphone"/>
            <input type="text" v-else disabled name="custphone" class="word5" value="***********"/>
        </div>
        <div class="iterm">
            <span class="star">*</span>
        ...
        <div class="iterm">
            ...
            <input v-bind:disabled="detailShow" type="text" name="fangwuguzhi" v-model="fangbaobei.fangwuguzhi" style="width:62%;"/>
        </div>
        <div class="iterm">
        ...
        <!--<div class="iterm">-->
            ...
            <!--<input v-bind:disabled="showor" type="text" name="xinshenyuanqianzi" :value="xinshenyuanqianzi" class="word5"/>-->
        <!--</div>-->
        <!--<div class="iterm">-->
...
//    import singleTime from '@/components/search-date2';
    ...
    export default {
        ...
        props:['fangbaobei','showsave','detailShow','step'],
        methods:{
            send(){
...
//                   if(this.fangbaobei.zhuguan==""||this.fangbaobei.zhuguan==null){
...
//                   }
                   ...
                   if(this.step==0){
                       this.url=host+"/app/saveReport?uuid="+this.uuid;
                   }else{
                       this.url=host+"/app/saveReportAgain?uuid="+this.uuid;
                   }
                   axios.post(this.url,
                       this.fangbaobei
                   ).then(response=>{
