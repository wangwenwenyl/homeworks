<template>
  <div id="app" style="overflow-Y:scroll;">
    <ContractTop tle="合同审批" tleurl="/index" style="position:fixed;top:0px;z-index:999;"></ContractTop>
    <heTongShenPiBlock style="margin-top:44px;"></heTongShenPiBlock>
  </div>
</template>
<script>
  import ContractTop from '@/components/ContractTop';
  import heTongShenPiBlock from '@/components/old/heTongShenPiBlock';
  ...
  export default {
    ...
    components:{
      ...
      'heTongShenPiBlock':heTongShenPiBlock
    }
  }
</script>
<style scoped>
