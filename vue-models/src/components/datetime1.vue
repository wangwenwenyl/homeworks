<template>
  <div class="page-popup" style="overflow-Y:scroll">
    ...
    <mt-popup v-model="popupVisible4" position="bottom" class="mint-popup-4" style="width:100%;">
      <mt-picker :slots="dateSlots" @change="onDateChange" :visible-item-count="5" :show-toolbar="true"></mt-picker>
      <div style="position:fixed;top:0px;">阿斯蒂芬</div>
    </mt-popup>
  </div>
</template>
