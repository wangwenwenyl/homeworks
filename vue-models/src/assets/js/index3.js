(function () {
    ...
    function demo_report(src, size, pengul,obj) {
        ...
        }else if(obj.attr("info")=='relationinfo'){
            img.setAttribute('info',idd4);
            img.setAttribute('infoin','relationinfo');
        }else if(obj.attr("info")=='relationcard'){
            img.setAttribute('info',idd5);
            img.setAttribute('infoin','relationcard');
        }
    ...
    imgcl = function(){
        $('.ImgClose').unbind('click').bind('click',function(){
            ...
            if($(this).prev().attr("infoin")=="gphotos"){
                ...
                allfile3[$(this).prev().attr('info')]='';
            }else if($(this).prev().attr("infoin")=="relationinfo"){
                allfile4[$(this).prev().attr('info')]='';
            }else if($(this).prev().attr("infoin")=="relationcard"){
                allfile5[$(this).prev().attr('info')]='';
            }
